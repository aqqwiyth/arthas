...
import com.taobao.arthas.core.command.klass100.SetStaticCommand;
...
import com.taobao.arthas.core.command.monitor200.DnsCommand;
...
public class BuiltinCommandPack implements CommandResolver {
    ...
    private static void initCommands() {
        ...
        commands.add(Command.create(SetStaticCommand.class));
