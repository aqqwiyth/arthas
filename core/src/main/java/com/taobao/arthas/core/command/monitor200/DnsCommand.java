...
@Description("Examples:\n" +
        ...
        "dns set xx.domain host expire time(second), default -1L forever time |exp:   dns set taobao.com 127.0.0.1 -1 |对某一个域名设置解析,并且附带过期时间.默认为-1永不过期  \n" +
        "dns remove xx.domain | dns remove taobao.com  | 删除一个DNS缓存,下次请求的时候会从dns获取   \n"
)
